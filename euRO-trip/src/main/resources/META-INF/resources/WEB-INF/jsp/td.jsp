			...
			<div class="scroller">
				<div class="room room--current">
					<div class="room__side room__side--back">
						<img class="room__img" src="img/timisoara.jpg">
						<img class="room__img" src="img/timisoara2.jpg" alt="Some image"/>


					</div>
					</section>
					<div class="room__side room__side--left">
						<img class="room__img" src="img/timisoara3.jpg" alt="Some image"/>
						<img class="room__img" src="img/timisoara4.jpg" alt="Some image"/>
						<img class="room__img" src="img/timisoara5.jpg" alt="Some image"/>

					</div>
					<div class="room__side room__side--right">
						<img class="room__img" src="img/timisoara6.jpg" alt="Some image"/>
						<img class="room__img" src="img/timisoara5.jpg" alt="Some image"/>
						<img class="room__img" src="img/timisoara5.jpg" alt="Some image"/>
					</div>
		...
		<div class="content">
			<header class="codrops-header">
				<div class="codrops-links">
					<a class="codrops-icon codrops-icon--prev" href="/orase" title="Orașe"><svg class="icon icon--arrow"><use xlink:href="#icon-arrow"></use></svg></a>
					<a class="codrops-icon codrops-icon--drop" href="/" title="Acasă"><svg class="icon icon--drop"><use xlink:href="#icon-drop"></use></svg></a>
				</div>
				<h1 class="codrops-header__title">Galerie 3D</h1>
				<div class="subject">Timișoara</div>
				...
				<div class="overlay overlay--menu">
					<ul class="menu">
						<li class="menu__item menu__item--current"><a class="menu__link" href="#">Obiective Turistice</a></li>
						<li class="menu__item"><a class="menu__link" href="#">Cazare</a></li>
						<li class="menu__item"><a class="menu__link" href="#">Restaurante</a></li>
						<li class="menu__item"><a class="menu__link" href="#">Baruri</a></li>
					</ul>
				</div>
				<div class="overlay overlay--info">
					<p class="info">&ldquo;Timișoara&rdquo; Este un centru industrial, comercial, medical și universitar important pentru vestul țării. Numele localității provine de la cel al râului Timiș, combinat cu substantivul maghiar vár, „cetate”, adică Cetatea Timișului.</p>
				</div>
			</header>
